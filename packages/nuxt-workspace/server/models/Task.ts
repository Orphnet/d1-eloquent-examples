...
export class Task extends BaseModel<TaskAttrs, {}, TaskRelations> {
    ...
    static override casts = { priority: "integer", estimated_hours: "real" } as const;
    ...
    static override revisionRedact = ["updated_at"];
